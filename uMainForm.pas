...
begin
  ...
  MenuMT.AppendRecord(['wordpress.wp_commentmeta','getwp_commentmetaExecute','postwp_commentmetaExecute','deletewp_commentmetaExecute','getwp_commentmetaMemTable1','postwp_commentmetaPostMemTable2','meta_id']);
  MenuMT.AppendRecord(['wordpress.wp_comments','getwp_commentsExecute','postwp_commentsExecute','deletewp_commentsExecute','getwp_commentsMemTable4','postwp_commentsPostMemTable5','comment_ID']);
  MenuMT.AppendRecord(['wordpress.wp_links','getwp_linksExecute','postwp_linksExecute','deletewp_linksExecute','getwp_linksMemTable7','postwp_linksPostMemTable8','link_id']);
  MenuMT.AppendRecord(['wordpress.wp_options','getwp_optionsExecute','postwp_optionsExecute','deletewp_optionsExecute','getwp_optionsMemTable10','postwp_optionsPostMemTable11','option_id']);
  MenuMT.AppendRecord(['wordpress.wp_postmeta','getwp_postmetaExecute','postwp_postmetaExecute','deletewp_postmetaExecute','getwp_postmetaMemTable13','postwp_postmetaPostMemTable14','meta_id']);
  MenuMT.AppendRecord(['wordpress.wp_posts','getwp_postsExecute','postwp_postsExecute','deletewp_postsExecute','getwp_postsMemTable16','postwp_postsPostMemTable17','ID']);
  MenuMT.AppendRecord(['wordpress.wp_term_relationships','getwp_term_relationshipsExecute','postwp_term_relationshipsExecute','deletewp_term_relationshipsExecute','getwp_term_relationshipsMemTable19','postwp_term_relationshipsPostMemTable20','object_id']);
  MenuMT.AppendRecord(['wordpress.wp_term_taxonomy','getwp_term_taxonomyExecute','postwp_term_taxonomyExecute','deletewp_term_taxonomyExecute','getwp_term_taxonomyMemTable22','postwp_term_taxonomyPostMemTable23','term_taxonomy_id']);
  MenuMT.AppendRecord(['wordpress.wp_termmeta','getwp_termmetaExecute','postwp_termmetaExecute','deletewp_termmetaExecute','getwp_termmetaMemTable25','postwp_termmetaPostMemTable26','meta_id']);
  MenuMT.AppendRecord(['wordpress.wp_terms','getwp_termsExecute','postwp_termsExecute','deletewp_termsExecute','getwp_termsMemTable28','postwp_termsPostMemTable29','term_id']);
  MenuMT.AppendRecord(['wordpress.wp_usermeta','getwp_usermetaExecute','postwp_usermetaExecute','deletewp_usermetaExecute','getwp_usermetaMemTable31','postwp_usermetaPostMemTable32','umeta_id']);
  MenuMT.AppendRecord(['wordpress.wp_users','getwp_usersExecute','postwp_usersExecute','deletewp_usersExecute','getwp_usersMemTable34','postwp_usersPostMemTable35','ID']);
